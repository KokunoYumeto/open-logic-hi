...
\item मान लें $!A \in \Gamma$। यदि $\lnot !A \in \Gamma$ भी, तो $\Gamma$
  ...
  \olref[pl][axd][prv]{prop:provability-exhaustive} से $\Gamma\cup\{!A\}$ और $\Gamma \cup \{\lnot
...
\item प्रत्येक $n$ के लिए समुच्चय $\Gamma_n$ संगत है ($n$ पर आगमन और
  \olref[pl][axd][prv]{prop:provability-exhaustive} के उपयोग से);
\item $\Gamma^*$ संगत है;
...
\begin{proof}
यदि $\Gamma\Proves/ !A$, तो \olref[pl][axd][prv]{prop:prov-incons} से $\Gamma \cup
