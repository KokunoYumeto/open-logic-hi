% Target-only integrated chapter build wrapper for HI-OLP-MTB-INT-CHAPTER-0001.
\documentclass[../../../include/open-logic-section]{subfiles}
\usepackage{xr-hyper}
\externaldocument{interpolation-external-labels}
...
\renewcommand*{\olshortlicensetext}[1]
  {\textit{\href{\OLTlinkname}{अंतर्वेशन प्रमेय}}
  \ifgitinfo\
  #1 द्वारा /
