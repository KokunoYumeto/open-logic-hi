...
\olfileid[hi]{nml}{prf}{prk}

\olsection{$\Log{K}$ में प्रमाण}

सबसे छोटे मोडल तंत्र में प्रमाणों का अभ्यास करने के लिए हम दिखाते हैं कि
\olref[syn][sch]{tab:valid-invalidSchemas} के बाएँ पक्ष के सभी मान्य
!!{formula}ों के $\Log{K}$-प्रमाण दिए जा सकते हैं।
...
\end{derivation}
ध्यान दें कि पंक्ति~$9$ का !!{formula} इस सर्वसत्यता का दृष्टांत है:
\[
...
\begin{proof}
  ...
  \end{derivation}
  पंक्तियों $6$ और $9$ के !!{formula} इन सर्वसत्यताओं के दृष्टांत हैं:
  \begin{align*}
...
\begin{proof}
  ...
  \end{derivation}
  पंक्तियों $8$ और $10$ के !!{formula} इन सर्वसत्यताओं के दृष्टांत हैं:
  \begin{align*}
  ...
  \end{derivation}
  अंतिम पंक्ति $\lnot \Box p \lif \Diamond\lnot p$ है, क्योंकि
  $\Diamond$ को $\lnot\Box\lnot$ के रूप में परिभाषित किया गया है।
  पंक्ति~$5$ का !!{formula} इस सर्वसत्यता का दृष्टांत है:
  \[
    (p \lif q) \lif (\lnot q \lif \lnot p).
  \]
  }}{% Box is defined
  ...
  \end{derivation}
  पंक्ति~$4$ का !!{formula} इस सर्वसत्यता का दृष्टांत है:
  \begin{align*}
...
\begin{prob}
  निम्न !!{formula}ों के लिए $\Log{K}$ में !!{derivation}याँ खोजिए:
  \begin{enumerate}
