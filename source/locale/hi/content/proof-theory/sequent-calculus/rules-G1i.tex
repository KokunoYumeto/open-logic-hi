...
\DisplayProof
\end{tabular}
\caption{अंतःप्रज्ञात्मक तर्क के लिए \Log{G1i} के नियम।
...
\RightR{\Contraction} नियम नहीं है। \Log{G1m}, \Log{G1i} में से
\RightR{\Weakening} और $\lfalse, \Gamma \Sequent \Delta$ अभिगृहीतियाँ
हटाने पर मिलता है।}
\ollabel{tab:G1c}
\end{table}
