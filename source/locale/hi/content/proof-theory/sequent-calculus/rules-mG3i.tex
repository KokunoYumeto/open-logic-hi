...
\DisplayProof
\end{tabular}
\caption{अंतःप्रज्ञात्मक तर्क के लिए बहु-निष्कर्ष \Log{mG3i} के नियम।
$\RightR{\forall}$ और $\LeftR{\exists}$ में !!{constant}~$a$ निष्कर्ष
अनुक्रम में नहीं आना चाहिए। $\Gamma$ और $\Delta$, !!{formula}s के
बहुसमुच्चय हैं। अभिगृहीतियों में !!{formula}~$!C$ परमाण्विक होना चाहिए।
\Log{mG1m}, \Log{mG1i} में से $\lfalse, \Gamma \Sequent \Delta$
अभिगृहीतियाँ हटाने पर मिलता है।}
\ollabel{tab:G3c}
\end{table}
